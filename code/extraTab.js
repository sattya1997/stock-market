...
childElement.style.display = 'none';  // Initially hide the element

parentDiv.appendChild(childElement);  // Add child element (hidden)

checkbox.addEventListener('change', () => {
  if (checkbox.checked) {
    childElement.style.display = 'block';  // Show the element
  } else {
    childElement.style.display = 'none';  // Hide the element
  }
});